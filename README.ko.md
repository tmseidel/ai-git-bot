...
| **llama.cpp** (로컬 GGUF 모델) | **Azure DevOps** (Services & Server) |
...
- 🐳 Docker 퍼스트 배포
- 🌍 엔드투엔드 셀프호스트 지원
- ♻️ AI 프로바이더가 과부하(HTTP 503)를 보고할 때 백오프 자동 재시도 — 영향을 받는 PR 또는 이슈에 다음 시도 시각이 안내됩니다
...
* 🚀 >15 릴리스
* 🐳 Docker 이미지 이용 가능
* 🌍 GitHub, Gitea, GitLab, Bitbucket, Azure DevOps 사용자
