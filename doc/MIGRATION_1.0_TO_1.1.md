...
> **Important:** If you don't set this key, credentials are stored in plain text and SSH private keys are rejected. Generate a strong, stable key, e.g.: `openssl rand -base64 32`
