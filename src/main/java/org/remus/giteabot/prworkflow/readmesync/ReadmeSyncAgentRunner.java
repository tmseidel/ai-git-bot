...
/**
 * Lightweight chat-and-dispatch loop for the {@link ReadmeSyncAgent}.
 *
 * <p>Mirrors {@code UnitTestAgentRunner} one-to-one — native function calling
 * when the provider supports it, transparent legacy-envelope fallback
 * otherwise — but dispatches {@code doc-write} / {@code doc-delete} calls to
 * the {@link ReadmeSyncToolExecutor} against the real repository checkout.</p>
 */
@Slf4j
public final class ReadmeSyncAgentRunner {

    private final AiClient aiClient;
    private final ReadmeSyncToolExecutor toolExecutor;
    private final ReadmeSyncToolContext toolContext;
    ...
    public ReadmeSyncAgentRunner(AiClient aiClient,
                                 ReadmeSyncToolExecutor toolExecutor,
        ...
        this.agentLabel = agentLabel == null ? "readme-sync" : agentLabel;
