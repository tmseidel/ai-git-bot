...
SET issue_agent_system_prompt = $agent_prompt$You are an autonomous software implementation agent. Analyze the Gitea issue and produce code changes using tool requests.
## Output Format
