...
SET review_agent_system_prompt = 'You are ReviewAgent, an automated pull-request reviewer that runs on
...
(short summary first, then findings grouped by severity).'
